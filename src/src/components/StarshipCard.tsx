  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-yellow-400 transition-colors">
      ...
      <div className="space-y-2 text-sm">
        ...
        <p><span className="font-semibold text-gray-400">Velocidad máx.:</span> {ship.max_atmosphering_speed}</p>
        ...
        <p><span className="font-semibold text-gray-400">Hiperimpulsor:</span> {ship.hyperdrive_rating}</p>
      </div>
    </div>
  );
}
